...
fps_cajanus <- readxl::read_excel("D:/OneDrive - CGIAR/Documents/Publications/CWR_Capsicum/article/Figures/Fig2/species_summary_2019-07-24_fig.xlsx", sheet = 1)
...
p <- p + ggplot2::annotate("text",
                           ...
                           size   = 4)
p
ggsave("D:/priority_graph_capsicum.png", plot = p, device = "png", units = "in", width = 10, height = 12, dpi = 320)

...
#Source new versions of scripts with edits
...
inSRS <- SRSin(Species_list = Sl, Occurrence_data = Od,
                            Raster_list = Rl, Pro_areas = Pro_areas, 
                            Gap_Map = TRUE)

inGRS <- GRSin(Species_list = Sl, Occurrence_data = Od,
                            Raster_list = Rl, Pro_areas = Pro_areas,
                            Gap_Map = TRUE)

inERS <- ERSin(Species_list = Sl, Occurrence_data = Od,
                            Raster_list = Rl, Pro_areas = Pro_areas, 
                            Ecoregions_shp = Ecoregions_shp, Gap_Map = TRUE)

inFCS <- FCSin(Species_list = Sl, Occurrence_data = Od,
                            Raster_list = Rl, Pro_areas = Pro_areas, 
                            Ecoregions_shp = Ecoregions_shp)


#Ex situ
exSRS <- SRSex(Species_list = Sl, Occurrence_data = Od)
